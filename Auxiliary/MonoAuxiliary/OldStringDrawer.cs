...
namespace Auxiliary
{
    public static class OldStringDrawer
    {
        ...
        public static Rectangle GetMultiLineTextBounds(string text, Rectangle rectangle, SpriteFont font = null)
        {
            ...
            DrawMultiLineTextDetailedParameters(spriteBatch, font, text, rectangle, Color.Black, TextAlignment.TopLeft, true, new Vector2(0, 0), out bounds, out empty, onlyGetBounds: true);
            return bounds;
        }
        /// <summary>
