...
namespace Auxiliary
{
    ...
    public class MessageBoxPhase : GamePhase
    {
        ...
        public Action<string> WhatWithNewName { get; }
        ...
        protected internal override void Initialize(Game game)
        {
            ...
            if (ButtonsType == MessageBoxButtons.InputOKCancel)
            {
                numbuttons = 2; doOKButton = true; doCancelButton = true;
                textbox = new Textbox("", new Rectangle(TopLeftX + 10, buttony - 50, Width - 20, 40 ));
            }
        ...
        protected internal override void Draw(SpriteBatch sb, Game game, float elapsedSeconds)
        {
            ...
            Primitives.DrawAndFillRectangle(rectTitle, Color.White, Skin.OuterBorderColor, Skin.OuterBorderThickness);
            ...
            Primitives.DrawMultiLineText(Text, new Rectangle(rectBox.X + 55, rectBox.Y + 50, rectBox.Width - 65, rectBox.Height - 40), Skin.TextColor, FontFamily.Normal, Primitives.TextAlignment.Top);
            textbox?.Draw();
